  ...
  return (
    <main className="flex min-h-dvh lg:h-dvh gap-[2vmin] p-[2vmin] pb-16 lg:pb-[1.6vmin]">
      ...
      <aside className="flex w-[28vw] min-w-[260px] shrink-0 flex-col gap-[1.5vmin]">
        ...
        <div>
          <p className="font-display text-[clamp(0.8rem,1.15vw,1.35rem)] uppercase tracking-[0.25em] text-moon-deep">Category</p>
          ...
          {state.order.map((id) => {
            ...
            return (
              ...
              >
                ...
                {state.phase === "vote" && <span className="text-[clamp(0.8rem,1.15vw,1.35rem)] text-moon-deep">{voted ? "✓" : "…"}</span>}
              </div>
            );
          })}
        </div>
