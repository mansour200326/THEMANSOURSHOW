...
export default function Home() {
  ...
  return (
    <main className="relative">
       ...
       */}
      <HeroStage footnote={t("Seventeen games · the TV is the stage, your phone is the controller · no downloads, no accounts")}>
        <ShowMark />
        ...
        >
          ...
          >
            {opening ? t("Opening the room…") : t("Host a game")}
          </button>
          <Link href="/play" className="btn-ghost px-12 py-5 text-xl sm:text-2xl">{t("Join a game")}</Link>
        </motion.div>
      </HeroStage>
    </main>
  );
